...
import { BoxBufferGeometry, ConeBufferGeometry, Float32BufferAttribute, Fog, Group, Mesh, MeshStandardMaterial, PlaneGeometry, PointLight, RepeatWrapping, SphereBufferGeometry, Texture } from 'three'
...
].forEach(t => { t.repeat.set(8, 8); t.wrapS = RepeatWrapping; t.wrapT = RepeatWrapping })
/**
 * House
 */
// Temporary sphere
